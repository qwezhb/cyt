...
var data = [];
for(var i=0;i<334;i++){
    data[i] = {id:i+1,name:"jason"+(i+1),gender:"男",age:26,address:"滨江",peopleid:320501199409137045,nation:"汉",result:"已审核",code:201305019};
}

var cs = new table({
     "tableId":"cs_table",    //必须
     "headers":["序号","姓名","性别","年龄","地址","身份证","民族","系统审核结果","户籍码"],   //必须
     "data":data,       //必须
